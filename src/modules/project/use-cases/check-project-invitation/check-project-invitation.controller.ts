...
@ApiTags('project')
@Controller()
export class CheckProjectInvitationController {
  ...
  @ApiOperation({
    summary: '프로젝트 초대장 체크',
    description: '프로젝트에 초대받은 사람만 체크가 가능함',
  })
  @ApiBearerAuth()
  @ApiOkResponse({ type: ProjectInvitationResponseDto })
  @UseGuards(JwtAuthGuard)
  @HttpCode(HttpStatus.OK)
  @Post('projects/:projectId/invitations/:invitationId/check')
  async checkProjectInvitation(
    ...
    try {
      const command = new CheckProjectInvitationCommand({
