...
@ApiTags('project')
@Controller()
export class CheckProjectApplicationController {
  ...
  @ApiOperation({
    summary: '프로젝트 지원서 체크',
    description: '프로젝트 소유자만 체크가 가능함',
  })
  @ApiBearerAuth()
  @ApiOkResponse({ type: ProjectApplicationResponseDto })
  @UseGuards(JwtAuthGuard)
  @HttpCode(HttpStatus.OK)
  @Post('projects/:projectId/applications/:applicationId/check')
  async checkProjectApplication(
    ...
    try {
      const command = new CheckProjectApplicationCommand({
