...
@ApiTags('project')
@Controller()
export class RejectProjectApplicationController {
  ...
  @ApiOperation({
    summary: '프로젝트 지원서 거절',
    description: '프로젝트 소유자만 거절이 가능함',
  })
  @ApiBearerAuth()
  @ApiOkResponse({ type: ProjectApplicationResponseDto })
  @UseGuards(JwtAuthGuard)
  @HttpCode(HttpStatus.OK)
  @Post('projects/:projectId/applications/:applicationId/reject')
  async rejectProjectApplication(
    ...
    try {
      const command = new RejectProjectApplicationCommand({
