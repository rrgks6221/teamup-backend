...
@ApiTags('project')
@Controller()
export class ApproveProjectInvitationController {
  ...
  @ApiOperation({
    summary: '프로젝트 초대장 승인',
    description: '프로젝트에 초대받은 사람만 승인이 가능함',
  })
  @ApiBearerAuth()
  @ApiOkResponse({ type: ProjectInvitationResponseDto })
  @UseGuards(JwtAuthGuard)
  @HttpCode(HttpStatus.OK)
  @Post('projects/:projectId/invitations/:invitationId/approve')
  async approveProjectInvitation(
    ...
    try {
      const command = new ApproveProjectInvitationCommand({
